...
func helpText() string {
	return strings.Join([]string{
		"Usage: rune-perf-bench [options]",
		"       rune-perf-bench tasks [options]   (Terminal-Bench-style task harness; see `tasks --help`)",
		"       rune-perf-bench turn  [options]   (per-turn tracing benchmark; see `turn --help`)",
		"",
		"Options:",
