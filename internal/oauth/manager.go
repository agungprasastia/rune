...
type ManagerOptions struct {
	...
	// operator exporting RUNE_OAUTH_ALLOW_PRESETS — used by the interactive wizard
	...
	// RUNE_OAUTH_<NAME>_* overrides. Leave false for hermetic tests.
	AllowPresets  bool
	Now           func() time.Time
...
func (m *Manager) resolveConfigForKey(ctx context.Context, key string) (Config, error) {
	...
	// provider configured with only RUNE_OAUTH_<NAME>_ISSUER_URL can still refresh
