...
func TestNewManagerAllowPresetsForcesOptIn(t *testing.T) {
	...
	if m.env["RUNE_OAUTH_ALLOW_PRESETS"] != "1" {
		t.Fatalf("AllowPresets should force the opt-in; got env[%q]=%q", "RUNE_OAUTH_ALLOW_PRESETS", m.env["RUNE_OAUTH_ALLOW_PRESETS"])
	}
...
func TestManagerLoginLoopback(t *testing.T) {
	...
	env := map[string]string{
		"RUNE_OAUTH_DEMO_CLIENT_ID":     "client",
		"RUNE_OAUTH_DEMO_AUTHORIZE_URL": "https://auth.example.com/authorize",
		"RUNE_OAUTH_DEMO_TOKEN_URL":     fp.server.URL + "/token",
	}
...
func TestManagerLoginDevice(t *testing.T) {
	...
	env := map[string]string{
		"RUNE_OAUTH_DEMODEV_CLIENT_ID":  "client",
		"RUNE_OAUTH_DEMODEV_TOKEN_URL":  fp.server.URL + "/token",
		"RUNE_OAUTH_DEMODEV_DEVICE_URL": fp.server.URL + "/device",
	}
...
func TestManagerPrepareAndCompleteDeviceLogin(t *testing.T) {
	...
	env := map[string]string{
		"RUNE_OAUTH_DEMO2_CLIENT_ID":  "client",
		"RUNE_OAUTH_DEMO2_TOKEN_URL":  fp.server.URL + "/token",
		"RUNE_OAUTH_DEMO2_DEVICE_URL": fp.server.URL + "/device",
	}
	m := managerFor(t, env, nil)
...
func TestManagerGetFreshDiscoversIssuerEndpoints(t *testing.T) {
	...
	env := map[string]string{
		"RUNE_OAUTH_ISSUERONLY_CLIENT_ID":  "client",
		"RUNE_OAUTH_ISSUERONLY_ISSUER_URL": server.URL, // no TOKEN_URL → discovered
	}
	m := managerFor(t, env, nil)
...
func TestManagerLogout(t *testing.T) {
	m := managerFor(t, map[string]string{"RUNE_OAUTH_DEMO_CLIENT_ID": "c"}, nil)
