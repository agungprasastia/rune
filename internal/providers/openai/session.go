...
func NewTurnSessionProvider(provider *Provider, caps runeruntime.ProviderCapabilities) runeruntime.TurnSessionProvider {
...
func (p *turnSessionProvider) OpenTurnSession(context.Context) (runeruntime.TurnSession, error) {
	return &turnSession{provider: p.provider}, nil
}

func (p *turnSessionProvider) Capabilities() runeruntime.ProviderCapabilities {
	return p.caps
}
...
func (s *turnSession) Stream(ctx context.Context, request runeruntime.CompletionRequest) (<-chan runeruntime.StreamEvent, error) {
	s.observePrefix(ctx, request)
	return s.provider.StreamCompletion(ctx, request)
}

func (s *turnSession) Compact(context.Context, runeruntime.CompletionRequest) ([]runeruntime.Message, error) {
...
func (s *turnSession) observePrefix(ctx context.Context, request runeruntime.CompletionRequest) {
...
func (s *turnSession) computeFingerprint(request runeruntime.CompletionRequest) string {
...
func wireToolsDigest(tools []runeruntime.ToolDefinition) string {
