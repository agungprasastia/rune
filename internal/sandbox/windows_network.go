...
// infrastructure that `rune sandbox setup` installs: the persistent outbound
	...
	return []WindowsWFPFilterSpec{
		{
			...
			Name:        "rune_wfp_block_connect_v4",
		...
		},
		{
			...
			Name:        "rune_wfp_block_connect_v6",
