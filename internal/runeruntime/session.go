...
// or reasoning types — because modelregistry imports runeruntime, so a typed
...
var ErrCompactionUnsupported = errors.New("runeruntime: native compaction unsupported")
