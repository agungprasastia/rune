...
func TestInspectSummarizesChangesAndRedactsDiff(t *testing.T) {
	...
	runner := &fakeRunner{results: []CommandResult{
		...
		{Stdout: "feature/m5\n"},
		{Stdout: "abc1234\n"},
		{Stdout: " M internal/verify/verify.go\x00?? internal/runegit/runegit.go\x00"},
		{Stdout: "abc1234\n"},
		{},
		{},
	...
	if summary.Files[1].Path != "internal/runegit/runegit.go" || summary.Files[1].Status != "untracked" || !summary.Files[1].Untracked {
...
func TestCreatePRCommandConstruction(t *testing.T) {
	t.Run("CreatePRWithAllOptions", func(t *testing.T) {
		root := t.TempDir()
		runner := &fakeRunner{results: []CommandResult{
			{Stdout: "https://github.com/agungprasastia/rune/pull/123\n"},
		}}
		...
		if result.Output != "https://github.com/agungprasastia/rune/pull/123\n" {
	...
	t.Run("CreatePRMinimal", func(t *testing.T) {
		root := t.TempDir()
		runner := &fakeRunner{results: []CommandResult{
			{Stdout: "https://github.com/agungprasastia/rune/pull/124\n"},
		}}
