...
func TestReducedMotionEnabled(t *testing.T) {
	...
	cases := []struct {
		...
		{"explicit 1", map[string]string{"RUNE_REDUCED_MOTION": "1"}, colorprofile.TrueColor, true},
		{"explicit true", map[string]string{"RUNE_REDUCED_MOTION": "true"}, colorprofile.TrueColor, true},
		{"explicit 0 is off", map[string]string{"RUNE_REDUCED_MOTION": "0"}, colorprofile.TrueColor, false},
		{"explicit false is off", map[string]string{"RUNE_REDUCED_MOTION": "false"}, colorprofile.TrueColor, false},
