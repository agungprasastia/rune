...
func (p *flakyProvider) StreamCompletion(_ context.Context, _ runeruntime.CompletionRequest) (<-chan runeruntime.StreamEvent, error) {
...
func TestStreamWithReconnectRecoversFromTransientDisconnect(t *testing.T) {
	...
	stream, err := streamWithReconnect(context.Background(), p, runeruntime.CompletionRequest{}, nil)
	if err != nil {
...
func TestStreamWithReconnectGivesUpAfterMax(t *testing.T) {
	...
	_, err := streamWithReconnect(context.Background(), p, runeruntime.CompletionRequest{}, nil)
	if err == nil {
...
func TestStreamWithReconnectStopsOnContextCancel(t *testing.T) {
	...
	_, err := streamWithReconnect(ctx, p, runeruntime.CompletionRequest{}, nil)
	if err == nil {
