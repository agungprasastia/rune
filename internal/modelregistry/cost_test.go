...
func TestRegistryEstimatesCostFromNormalizedUsage(t *testing.T) {
	...
	cost, err := registry.EstimateCost("gpt-4.1", runeruntime.Usage{
...
func TestRegistryCostSupportsAliasesAndFullyCachedInput(t *testing.T) {
	...
	cost, err := registry.EstimateCost("openai:gpt-4.1-mini", runeruntime.Usage{
		InputTokens:       1_000_000,
...
func TestRegistryCostUsesPromptAndCompletionAliases(t *testing.T) {
	...
	cost, err := registry.EstimateCost("haiku-3.5", runeruntime.Usage{
		PromptTokens:     2_000,
...
func TestRegistryCostIgnoresCachedInputWithoutCachePricing(t *testing.T) {
	...
	cost, err := registry.EstimateCost("gpt-4-turbo", runeruntime.Usage{
		InputTokens:       1_000,
...
func TestRegistryCostTreatsReasoningAsOutputBreakdown(t *testing.T) {
	...
	withReasoning, err := registry.EstimateCost("gpt-4.1", runeruntime.Usage{
		InputTokens:     1_000,
		OutputTokens:    1_000,
		ReasoningTokens: 400,
	})
	...
	plain, err := registry.EstimateCost("gpt-4.1", runeruntime.Usage{
		InputTokens:  1_000,
		OutputTokens: 1_000,
	})
	if err != nil {
...
func TestRegistryCostSelectsTierForLongContextPricing(t *testing.T) {
	...
	shortPrompt, err := registry.EstimateCost("gemini-2.5-pro", runeruntime.Usage{
		InputTokens:  200_000,
		OutputTokens: 1_000,
	})
	if err != nil {
	...
	longPrompt, err := registry.EstimateCost("gemini-2.5-pro", runeruntime.Usage{
		InputTokens:  200_001,
		OutputTokens: 1_000,
	})
	if err != nil {
...
func TestCostFormattingAndValidation(t *testing.T) {
	...
	_, err = registry.EstimateCost("gpt-4.1", runeruntime.Usage{InputTokens: -1})
	if err == nil {
