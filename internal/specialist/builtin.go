...
const workerPrompt = `You are a focused task specialist inside Rune.
...
const explorerPrompt = `You are a read-only codebase exploration specialist inside Rune.
...
const codeReviewPrompt = `You are a code review specialist inside Rune.
