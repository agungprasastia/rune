...
export GOCACHE="${GOCACHE:-/tmp/rune-go-cache}"
...
for goos in linux darwin windows; do
  ...
  compile_pkg "$goos" ./cmd/rune
done
compile_pkg linux ./cmd/rune-linux-sandbox
compile_pkg linux ./cmd/rune-seccomp
build_cmd windows ./cmd/rune-windows-command-runner rune-windows-command-runner.exe
build_cmd windows ./cmd/rune-windows-sandbox-setup rune-windows-sandbox-setup.exe
